...
/***/ (function(module, exports) {
...

	{
	  ...
	  var arr = [1, 2, 3, 4, 5];
	  var _list = new Set(arr); //直接往参数里传一个数组
...

	{
	  ...
	  console.log('list', _list2); // list Set
...

	{
	  ...
	  //判断是否有某个元素
	  console.log('has', _list3.has('add')); // has true
	  //删除元素
	  console.log('delete', _list3.delete('add'), _list3); // delete true Set {"delete", "clear", "has"}
	  _list3.clear(); //清空元素
	  console.log('list', _list3); // list Set {}
	}

	{
	  ...
	  try {
	    for (var _iterator4 = _list4[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
	      var _value2 = _step4.value;

	      console.log('list', _value2);
	    }
	    //利用forEach遍历
	  } catch (err) {
...

	{
	  ...
	  map.set(_arr4, 456); // 添加元素，key为arr数组，值为456

	  console.log('map', map, map.get(_arr4)); // map Map {["123"] => 456} 456
	}

	{
	  //也可以通过传参的方式，其参数是一个数组，数组的每个元素也是数组
	  var _map = new Map([['a', 123], ['b', 456]]);
	  console.log('map args', _map); // map args Map {"a" => 123, "b" => 456}
	  console.log('size', _map.size); // size 2
	  console.log('delete', _map.delete('a'), _map); // delete true Map {"b" => 456}
	  console.log('clear', _map.clear(), _map); // clear undefined Map {}
...

	{
	  ...
	  _map2.set('a', 1);
	  array.push({ 'a': 1 });
	  console.log('map-array-insert', _map2, array); // map-array Map {"a" => 1} [Object]
	  //查
	  var map_exist = _map2.has('a');
	  ...
	  }); //遍历每个item，判断key为a的item是否存在，存在则改
	  console.log('map-array-update', _map2, array);
	  //删
	  _map2.delete('a');
	  ...
	  console.log('map-array-delete', _map2, array); // map-array-delete Map {} []
	}

	{
	  ...
	  set.add({ t: 1 });
	  _arr5.push({ t: 1 });
	  console.log('set-array-insert', set, _arr5); //set-array-insert Set {Object {t: 1}} [Object]
	  ...
	  console.log('set-array-update', set, _arr5); //set-array-update Set {Object {t: 2}} [Object]

	  //删
	  set.forEach(function (item) {
	    return item.t ? set.delete(item) : '';
	  });
	  var _index = _arr5.findIndex(function (item) {
	    return item.t;
	  });
	  _arr5.splice(_index, 1);
	  console.log('set-array-delete', set, _arr5); // set-array-delete Set {} []
	}

	{
	  ...
	  _map3.set('t', 1);
	  obj['t'] = 1;
	  console.log("set-map-obj", _set, _map3, obj); //set-map-obj Set {Object {t: 1}} Map {"t" => 1} Object {t: 1}

	  //查
	  console.log({
	    'set-exist': _set.has(item),
	    'map-exist': _map3.has('t'),
	    'obj-exist': 't' in obj
	  ...
	  _map3.set('t', 2);
	  obj['t'] = 2;
	  console.log("set-map-obj-update", _set, _map3, obj); // set-map-obj-update Set {Object {t: 2}} Map {"t" => 2} Object {t: 2}

	  //删
	  _set.delete(item);
	  _map3.delete('t');
	  delete obj['t'];
	  console.log("set-map-obj-delete", _set, _map3, obj); // set-map-obj-delete Set {} Map {} Object {}
	}
